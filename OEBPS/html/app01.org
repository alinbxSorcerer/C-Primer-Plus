** <<page_861>>A. Answers to the Review Questions
   :PROPERTIES:
   :CUSTOM_ID: app01
   :END:
...
*** <<page_862>>Answers to Review Questions for Chapter 2
    :PROPERTIES:
    :CUSTOM_ID: app01lev1sec2
    :END:
...
[[file:app01_images.html#p862pro01][Click here to view code image]]
...
[[file:app01_images.html#p862pro02][Click here to view code image]]
...
[[file:app01_images.html#p862pro03][Click here to view code image]]
...
<<page_863>>(Note that there is no space after the period. You could have had a space by using ="Have= instead of ="Have=.)
...
*[[file:ch02.html#ch02que07][7]].* =printf("There were %d words and %d lines.\n", words, lines);=
...
<<page_864>>*[[file:ch03.html#ch03que03][3]].* To get exactly 32 bits, you could use =int32_t=, provided it was defined for your system. To get the smallest type that could store at least 32 bits, use =int_least32_t=. And to get the type that would provide the fastest computations for 32 bits, choose =int_fast32_t=.
...
[[file:app01_images.html#p864pro01][Click here to view code image]]
...
  tax = rate*g;\\
  h = g + tax;\\
<<page_865>>  printf("You owe $%f plus $%f in taxes for a total of $%f.\n", g, tax, h);\\
  return 0;\\
}
...
[[file:app01_images.html#p865pro01][Click here to view code image]]
...
<<page_866>>*[[file:ch03.html#ch03que10][10]].*   Line 0: Should have =#include <stdio.h>=.
...
[[file:app01_images.html#p866pro01][Click here to view code image]]
...
<<page_867>>(Note: The first character is a character constant, the second is a decimal integer converted to a character, and the third is an ASCII representation, in octal, of a character constant.)

*c.*

[[file:app01_images.html#p867pro01][Click here to view code image]]
...
[[file:app01_images.html#p867pro02][Click here to view code image]]

printf("\"%s\"\nhas %d characters.\n", Q, strlen(Q));

*[[file:ch04.html#ch04que04][4]].* Here is a corrected version:

[[file:app01_images.html#p867pro03][Click here to view code image]]
...
[[file:app01_images.html#p867pro04][Click here to view code image]]
...
[[file:app01_images.html#p868pro01][Click here to view code image]]
...
[[file:app01_images.html#p868pro02][Click here to view code image]]
...
[[file:app01_images.html#p868pro03][Click here to view code image]]
...
[[file:app01_images.html#p868pro04][Click here to view code image]]
...
<<page_869>>[[file:app01_images.html#p869pro01][Click here to view code image]]
...
[[file:app01_images.html#p869pro001][Click here to view code image]]
...
<<page_870>>*Line 7*: Because =1= and =i= are both integers, the result of the division will be =1= when =i= is =1=, and =0= for all larger values. Using =n = 1.0/i;= would cause =i= to be converted to floating point before division and would yield nonzero answers.
...
[[file:app01_images.html#p870pro01][Click here to view code image]]
...
[[file:app01_images.html#p870pro02][Click here to view code image]]
...
<<page_871>>The first time through, the =scanf()= outside the loop is used. Thereafter, the =scanf()= at the end of the loop (and hence just before the loop begins again) is used. This is a common method for handling problems of this sort, which is why [[file:ch05.html#ch05lis09][Listing 5.9]] used it.
...
[[file:app01_images.html#p871pro01][Click here to view code image]]
...
[[file:app01_images.html#p871pro02][Click here to view code image]]
...
[[file:app01_images.html#p871pro03][Click here to view code image]]
...
<<page_873>>*[[file:ch06.html#ch06que04][4]].   a.* =scanf("%d", &x) == 1=
...
[[file:app01_images.html#p873pro01][Click here to view code image]]
...
[[file:app01_images.html#p873pro02][Click here to view code image]]
...
[[file:app01_images.html#p874pro01][Click here to view code image]]
...
[[file:app01_images.html#p875pro01][Click here to view code image]]

for (index = 0; index < SIZE; index++)\\
    by\_twos[index] = 2 * (index + 1);

Similarly, the limits for the second loop should be changed. Also, an array index should be used with the array name:

[[file:app01_images.html#p875pro02][Click here to view code image]]

for( index = 0; index < SIZE; index++)\\
     printf("%d ", by\_twos[index]);
...
[[file:app01_images.html#p875pro03][Click here to view code image]]
...
[[file:app01_images.html#p875pro04][Click here to view code image]]
...
*** <<page_876>>Answers to Review Questions for Chapter 7
    :PROPERTIES:
    :CUSTOM_ID: app01lev1sec7
    :END:
...
[[file:app01_images.html#p876pro01][Click here to view code image]]
...
<<page_877>>   printf("your height in inches.\n");\\
...
[[file:app01_images.html#p877pro01][Click here to view code image]]
...
Or, more simply and more portably, you can include =ctype.h= and use =islower()=. Incidentally, ='a' <= ch >= 'z'= is valid C in terms of syntax; it just doesn't have the right meaning. Because relational operators associate left to right, the expression is interpreted as =('a' <= ch) >= 'z'=. The expression in parentheses has the value =1= or =0= <<page_878>>(true or false), and this value is checked to see whether it is equal to or greater than the numeric code for ='z'=. Neither =0= nor =1= satisfies that test, so the whole expression always evaluates to =0= (false). In the second test expression, =||= should be =&&=. Also, although =!(ch < 'A')= is both valid and correct in meaning, =ch >= 'A'= is simpler. The ='Z'= should be followed by two closing parentheses, not one. Again, more simply, use =isupper()=. The =oc++;= statement should be preceded by an =else=. Otherwise, it is incremented every character. The control expression in the =printf()= call should be enclosed in double quotes.

Here is a corrected version:

[[file:app01_images.html#p878pro01][Click here to view code image]]
...
[[file:app01_images.html#p878pro02][Click here to view code image]]
...
[[file:app01_images.html#p879pro01][Click here to view code image]]
...
<<page_880>>*[[file:ch08.html#ch08que02][2]].   a.* Display the H character.
...
[[file:app01_images.html#p880pro01][Click here to view code image]]
...
*** <<page_881>>Answers to Review Questions for Chapter 9
    :PROPERTIES:
    :CUSTOM_ID: app01lev1sec9
    :END:
...
[[file:app01_images.html#p881pro01][Click here to view code image]]
...
[[file:app01_images.html#p881pro02][Click here to view code image]]
...
[[file:app01_images.html#p882pro01][Click here to view code image]]
...
[[file:app01_images.html#p882pro02][Click here to view code image]]
...
[[file:app01_images.html#p882pro03][Click here to view code image]]
...
<<page_885>>Invalid; =rootbeer= is not a =float=.
...
[[file:app01_images.html#p885pro01][Click here to view code image]]
...
[[file:app01_images.html#p885pro02][Click here to view code image]]
...
[[file:app01_images.html#p885pro03][Click here to view code image]]
...
[[file:app01_images.html#p885pro04][Click here to view code image]]

show2( (int [][3]){{8,3,9}, {5,4,1}}, 2);

*** <<page_886>>Answers to Review Questions for Chapter 11
    :PROPERTIES:
    :CUSTOM_ID: app01lev1sec11
    :END:
...
[[file:app01_images.html#p887pro01][Click here to view code image]]
...
[[file:app01_images.html#p887pro02][Click here to view code image]]
...
[[file:app01_images.html#p888pro01][Click here to view code image]]
...
[[file:app01_images.html#p888pro02][Click here to view code image]]
...
[[file:app01_images.html#p888pro03][Click here to view code image]]
...
[[file:app01_images.html#p889pro01][Click here to view code image]]

#include <stdio.h>      /* for NULL definition          */\\
char * strblk(const char * string)\\
{\\
  while (*string != ' ' && *string != '\0')\\
<<page_889>>    string++;           /* stops at first blank or null */\\
  if (*string == '\0')\\
    return NULL;        /* NULL is the null pointer     */\\
  else\\
    return (char *) string;\\
...
[[file:app01_images.html#p889pro02][Click here to view code image]]
...
<<page_891>>*[[file:ch12.html#ch12que06][6]].* Both allocate an array of 100 =int= values. The statement using =calloc()= additionally sets each element to 0.
...
[[file:app01_images.html#p891pro01][Click here to view code image]]
...
[[file:app01_images.html#p892pro01][Click here to view code image]]
...
[[file:app01_images.html#p893pro01][Click here to view code image]]

#include <stdio.h>\\
#include <stdlib.h>\\
#define BUF 256\\
int has\_ch(char ch, const char * line);\\
int main(int argc,char * argv[])\\
{\\
   FILE * fp;\\
   char ch;\\
...
\\
<<page_894>>int has\_ch(char ch, const char * line)\\
{\\
   while (*line)\\
      if (ch == *line++)\\
         return(1);\\
...
[[file:app01_images.html#p895pro01][Click here to view code image]]
...
[[file:app01_images.html#p895pro02][Click here to view code image]]
...
[[file:app01_images.html#p895pro03][Click here to view code image]]
...
[[file:app01_images.html#p896pro01][Click here to view code image]]
...
[[file:app01_images.html#p896pro02][Click here to view code image]]
...
[[file:app01_images.html#p897pro01][Click here to view code image]]
...
void set\_mpgs(struct gas * ptrip)\\
{\\
  if (ptrip->gals > 0)\\
...
[[file:app01_images.html#p897pro02][Click here to view code image]]
...
[[file:app01_images.html#p897pro03][Click here to view code image]]

struct gas ohio = {583, 17.6};   // set first two members\\
set\_mpgs(&ohio);                  // set third member
...
[[file:app01_images.html#p897pro04][Click here to view code image]]

double sum(double, double);\\
double diff(double, double);\\
<<page_898>>double times(double, double);\\
double divide(double, double);\\
double (*pf1[4])(double, double) = {sum, diff, times, divide};

Or, more simply, replace the last line of code with these lines:

[[file:app01_images.html#p898pro01][Click here to view code image]]
...
[[file:app01_images.html#p898pro02][Click here to view code image]]
...
<<page_899>>*f.* 1 (true or true is true)
...
[[file:app01_images.html#p899pro01][Click here to view code image]]
...
[[file:app01_images.html#p899pro02][Click here to view code image]]
...
<<page_900>>*[[file:ch16.html#ch16que03][3]].* =#define MIN(X,Y) ( (X) < (Y) ? (X) : (Y) )=

*[[file:ch16.html#ch16que04][4]].* =#define EVEN_GT(X,Y) ( (X) > (Y) && (X) % 2 == 0 ? 1 : 0 )=

*[[file:ch16.html#ch16que05][5]].* =#define PR(X,Y) printf(#X " is %d and " #Y " is %d\n", X,Y)=
...
[[file:app01_images.html#p900pro01][Click here to view code image]]
...
[[file:app01_images.html#p900pro02][Click here to view code image]]

#define \_SKIP\_  /* remove when you don't want to skip code */\\
#ifndef \_SKIP\_\\
    /* code to be skipped */\\
#endif
...
[[file:app01_images.html#p900pro03][Click here to view code image]]
